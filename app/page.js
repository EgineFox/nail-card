...
const content = {
  ru: {
   ...
   serviceList: [
  { name: "Маникюр + Гель", desc: "Замачивание, придание формы, полировка и нанесение геля.", price: "150 ₪", time: "120 мин" },
  { name: "Маникюр", desc: "Форма, шлифовка и покрытие.", price: "100 ₪", time: "60 мин" },
...
showLess: "Скрыть",
  ...
  he: {
    ...
    serviceList: [
  { name: "מניקור + ג'ל", desc: "השריה, עיצוב צורה, ליטוש ומריחת לק ג'ל.", price: "150 ₪", time: "120 דקות" },
  { name: "מניקור אקספרס", desc: "עיצוב צורה, ליטוש וציפוי.", price: "100 ₪", time: "60 דקות" },
